...
input.addEventListener('mousedown', () => {
    document.getElementById("change-me").style.backgroundColor = 'blue';
});
...
// if the target (whatever you put the event listener on) is an input box, "e.target" has a ".value" 
// property. And it's whatever is in the input box. 
// Even if your input box is type="number", the value will be a string. Like, "243" vs 243. Remember,
// "1" + "1" === "11"